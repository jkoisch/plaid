...
Accounts and Transactions are objects that follow the JSON from Plaid. Thus you can expect to see
    ...
    r.accounts[2].balance["current"]            <= 8.98 (which is a double)
...
MFA requires some management of user flow, which is why this gem tries to make the returns from API calls explicit.
See the wiki for more information.

https://github.com/jkoisch/plaid/wiki
